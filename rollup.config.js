  ...
  ...["content.js", "background.js", "options.js"].map((fileName) => ({
    ...
    plugins: [
      copy({
        targets: [
          {
            src: srcWebExtensionDir + "icons/**/*.*",
            dest: buildWebExtensionDir + "icons",
          },
          {
            src: srcWebExtensionDir + "manifest.json",
            dest: buildWebExtensionDir,
          },
          {
            src: srcWebExtensionDir + "optionsPage.html",
            dest: buildWebExtensionDir,
          },
        ],
        copyOnce: true,
